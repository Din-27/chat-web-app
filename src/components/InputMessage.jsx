...
export default function InputMessage() {
    return (
        // <div class="relative mx-6 rounded-xl">
        //     <label for="Search" class="sr-only">Kirim Pesan</label>
        ...
        //         class="flex items-center h-[30px] text-xl resize-none border ring-none outline-none w-full rounded-md border-gray-200 pe-10 px-6 shadow-sm"
        //         name="" id="">

        //     </textarea>

        //     <span class="absolute inset-y-0 end-0 grid w-10 place-content-center">
        //         <button type="button" class="text-gray-600 hover:text-gray-700 border rounded-lg p-1 bg-purple-200">
